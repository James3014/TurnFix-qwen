...
import '../styles/FeedbackCollectionPage.css';
...
const FeedbackCollectionPage = () => {
  ...
  if (!session || !recommendedCards) {
    return (
      <div className="feedback-collection-page">
        ...
        <div className="radio-group">
          <label className="radio-label">
            <input
              ...
              name="feedback_type"
              value="immediate"
              checked={sessionFeedback.feedback_type === "immediate"}
              onChange={(e) => handleSessionFeedbackChange('feedback_type', e.target.value)}
            />
          ...
          <label className="radio-label">
            <input
              ...
              name="feedback_type"
              value="delayed"
              checked={sessionFeedback.feedback_type === "delayed"}
              onChange={(e) => handleSessionFeedbackChange('feedback_type', e.target.value)}
            />
            <span className="radio-custom"></span>
            延遲回饋（練習後評價）
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case 'session':
        return renderSessionFeedbackTab();
      case 'practice-card':
        return renderPracticeCardFeedbackTab();
      default:
        return renderSessionFeedbackTab();
    }
  };
